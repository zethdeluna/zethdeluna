			...
			<div className="container grid">
				...
				<article>
					...
					<div className="about-me">
						...
						<p>I'm Zeth, a frontend developer with years of experience crafting engaging sites through the magical languages of HTML, CSS, JavaScript, PHP, and React JavaScript/TypeScript. I love taking beautiful, aesthetically pleasing designs and turning them into real usable experiences. I'm not really a designer, but I do sometimes like to design things for myself—including this website!</p>
						<p>I've spent the last 5-ish years as a Frontend Developer at Studio Simpatico, but sadly (truly, I will miss my coworkers) this role has come to an end. I <em>have</em> to take a moment to share how lucky I feel to have ended up with this group of such amazing people, both professionally and personally! I've learned so much from them and had fun while doing it—the vibes are truly immaculate.</p>
