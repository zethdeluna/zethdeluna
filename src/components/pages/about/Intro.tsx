			...
			<div className="container grid">
				...
				<article>
					...
					<div className="about-me">
						...
						<p>I've been at my current role as Frontend Developer at Studio Simpatico for about 5 years. I <em>have</em> to take a moment to share how lucky I feel to have ended up with this group of such amazing people, both professionally and personally! I've learned so much from them and had fun while doing it—the vibes are truly immaculate.</p>
